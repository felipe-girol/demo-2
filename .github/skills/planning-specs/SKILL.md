...
- [The Specification file](../../../IA/specs/<spec-slug-id>.spec.md)
...
### Step 4: Write the implementation plan.
 ...
 - [ ] Write the plan to a markdown file at `IA/plans/<plan-slug-id>.plan.md`.
...
- [ ] A detailed implementation plan at `IA/plans/<plan-slug-id>.plan.md`.

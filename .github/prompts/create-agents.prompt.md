...
Follow this template and save in a markdown file `CLAUDE.md`:
...
```text
.                         # Project root  
├── CLAUDE.md             # This file with instructions for AI agents
...
- [ ] The output should be a markdown file named `CLAUDE.md`.

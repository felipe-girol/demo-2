...
The current branch `feat/rockets` has implementation of `IA/specs/rockets.spec.md` 

## Steps to follow:

1. **Verify Implementation**: 
   - Write e2e tests to ensure acceptance criteria from `IA/specs/rockets.spec.md`.
